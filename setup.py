...
setup(
  ...
  url = 'http://raccoondude.com',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/raccoondude/epy/archive/0.1.tar.gz',    # I explain this later on
